...
@Component({
  ...
  imports: [NavbarComponent, SidebarFilterComponent, ToplistComponent, LightboxComponent, PostComponent, CommonModule, IntersectionObserverComponent, LoadingComponent, UserComponent],
